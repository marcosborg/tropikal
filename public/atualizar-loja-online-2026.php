...
$marker = dirname(__DIR__).'/storage/app/tropikal-ecommerce-deployment-20260817.done';
$keyHash = 'fcebf16b0fd8325e08144420d94ceaa11269cf79b749f3e7579fc8e08982e6a8';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ! $completed) {
    ...
    if (! hash_equals($keyHash, hash('sha256', $key))) {
        ...
        foreach ([['migrate', ['--force' => true]], ['optimize:clear', []]] as [$command, $arguments]) {
