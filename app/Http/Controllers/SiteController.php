...
class SiteController extends Controller
{
    ...
    public function catalog(){ return view('catalog', $this->data()+['categories'=>Category::with(['children','products.images'])->whereNull('parent_id')->where('is_published',true)->orderBy('sort_order')->get()]); }
